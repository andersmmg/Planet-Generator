...
## Whether planets generate collision shapes.
const COLLISIONS_ENABLED := false
## TODO: Implement gravity.
const GRAVITY_ENABLED := true
## Whether to use threads for terrain generation.
const THREADS_ENABLED := true

## Increase this to make gravity fade faster than reality.
const GRAVITY := 0.000000981
